...
# export EXPERIMENT_NAME="eval-research-grpo-qwen2.5-3b-step120"

export BASE_MODEL="verl_checkpoints/nq_hotpotqa_train_base_score-search-r1-grpo-qwen2.5-3b-em-logging/actor/best_val_step_200"
export EXPERIMENT_NAME="eval-search-r1-grpo-qwen2.5-3b-step200"


data_name="nq_hotpotqa_train_refine_overhaul_2_score"
export BASE_MODEL="verl_checkpoints/nq_hotpotqa_train_refine_overhaul_2_score-grpo-qwen2.5-3b-it-f1-ref0.1/actor/best_val_step_80"
export EXPERIMENT_NAME="eval-ours-grpo-qwen2.5-3b-f1-step80"
