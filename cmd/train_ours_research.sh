...
export EXPERIMENT_NAME="$data_name-research-grpo-qwen2.5-3b-em-refine_score_0.2"
# export BASE_MODEL='Qwen/Qwen2.5-3B-Instruct'
# export EXPERIMENT_NAME="$data_name-research-grpo-qwen2.5-3b-it-em-refine_score_0.1"
