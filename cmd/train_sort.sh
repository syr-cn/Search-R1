...
export DATA_DIR='data/nq_hotpotqa_train_refine_sort3_easy_start'
...
export EXPERIMENT_NAME="nq_hotpotqa_train_refine_sort3_easy_start-r1-grpo-qwen2.5-3b-em-refine_score-0.2"
# export BASE_MODEL='Qwen/Qwen2.5-3B-Instruct'
# export EXPERIMENT_NAME="nq_hotpotqa_train_refine_sort3_filter_v5-r1-grpo-qwen2.5-3b-it-em"
