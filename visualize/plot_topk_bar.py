...
autorefine_acc = autorefine_df['Avg'].values
...
handles = [line, bars1, bars2, bars3]
labels = [line_label] + bar_labels
ax.legend(handles, labels, loc='upper left', fontsize=9, frameon=True, ncol=1)
