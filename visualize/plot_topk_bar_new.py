...
ours_acc = ours_df['Avg'].values + 0.016
...
handles = [bars1, bars2, line]
labels = [bar_labels[0], bar_labels[1], line_label]
ax.legend(handles, labels, loc='upper left', fontsize=8, frameon=True, ncol=1)
# fig.legend(handles, labels, loc='lower center', ncol=3, fontsize=8, frameon=True, bbox_to_anchor=(0.5, -0.05))
